    ...
    <div class="row m-4 border border-light" style="padding-left: 40%;">
        <form action="guardaPunto" method="POST">
            ...
            <div class="col text-center mb-2">
                <input type="text" class = "text-center" size="30" name="nombre" value="{{$recolector->nombre}}">
            </div>  
            <div class="col text-center mb-2">
                <input type="text" class = "text-center" size="30" name="diasRecoleccion" value="{{$recolector->diasRecoleccion}}">
            </div>  
            <div class="col text-center mb-2">
